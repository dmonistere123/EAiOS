...
export function readBuildVersion(eaiosRoot: string, distDir?: string): BuildVersion {
  const candidates = distDir ? [join(distDir, 'version.json')] : [
  ...
  throw new Error('Build version manifest unavailable');
}
